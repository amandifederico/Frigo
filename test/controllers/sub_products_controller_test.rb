...
class SubProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_product" do
    assert_difference('SubProduct.count') do
      post sub_products_url, params: { sub_product: { lot_id: @sub_product.lot_id, observartion: @sub_product.observartion } }
    end
  ...
  test "should update sub_product" do
    patch sub_product_url(@sub_product), params: { sub_product: { lot_id: @sub_product.lot_id, observartion: @sub_product.observartion } }
