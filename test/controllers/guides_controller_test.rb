...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { arrival_date: @guide.arrival_date, city_id: @guide.city_id, lot_id: @guide.lot_id, transport_id: @guide.transport_id } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { arrival_date: @guide.arrival_date, city_id: @guide.city_id, lot_id: @guide.lot_id, transport_id: @guide.transport_id } }
