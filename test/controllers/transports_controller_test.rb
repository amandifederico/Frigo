...
class TransportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transport" do
    assert_difference('Transport.count') do
      post transports_url, params: { transport: { capacity: @transport.capacity, coupled: @transport.coupled, driver: @transport.driver, model: @transport.model, plate: @transport.plate } }
    end
  ...
  test "should update transport" do
    patch transport_url(@transport), params: { transport: { capacity: @transport.capacity, coupled: @transport.coupled, driver: @transport.driver, model: @transport.model, plate: @transport.plate } }
