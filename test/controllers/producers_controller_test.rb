...
class ProducersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post producers_url, params: { producer: { city_id: @producer.city_id, down_date: @producer.down_date, name: @producer.name, observation: @producer.observation, up_date: @producer.up_date } }
    end
  ...
  test "should update producer" do
    patch producer_url(@producer), params: { producer: { city_id: @producer.city_id, down_date: @producer.down_date, name: @producer.name, observation: @producer.observation, up_date: @producer.up_date } }
